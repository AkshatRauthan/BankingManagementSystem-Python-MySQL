...
def account_creation():
    '''    
    This Function Helps Us To Directly Create Accounts Of New User By Entering Their Data
    And Assigning Them An Predefined Acount Naumber.
    
    Returns
    -------
    The Account Number Alloted To You By The System.
    '''
...
def account_details():
    '''
    This Function Fetches Us All The Details Of The Account Present In Our Database.

    Returns
    -------
    Details Of All The Account Present In The System.
    '''
...
def transaction_details():
    '''
    This Function Fetches Us All The Details Of All The Transactions In Chronological Order.

    Returns
    -------
    Details Of All The Transactions Made Through The System.
    '''
    Z=1
    while Z==1:
    ...
    if O==1:
        ...
        print(DB.head(Num),end='\n\n')
        time.sleep(4)        
def graph_of_accnt_balance():
    '''
    This Function Fetches Us The Account Balance Of All The Account Holder In Graphical Format.

    Returns
    -------
    Bar Graph Depicting The Bank Balance Of All The Customers Along Their Account Number.
    '''
    ...
    plt.grid(True)
    plt.show()
def change_default_backup_location():
    '''
    This Function Changes The Default Backup Location Of The Application

    Returns
    -------
    Confirmination That The DefaulThe Default Backup Location Has Been Updated.
    '''
    AK=1
    while AK==1:    
        ...
        while AK==2:
            ...
            if CC in ['Y','y']:
                a=pd.DataFrame([DDD])
                a.to_csv('C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/Default_Location.csv',index=None,header=None)
                AK=10
                time.sleep(2)
...
def backup(YYY):
    '''
    This Function Backup All The Data In A CSV File In The Required Locaction.

    Returns
    -------
    Confirmination That The Data Has Been Backed Up.
    '''
    mycursor.execute("select * from accounts")
    a=mycursor.fetchall()
...
def backup_all_files():
    '''
    This Function Helps Us To Select The Location Where We Want To Backup Up All The Files In CSV Format
    ...
    while ALA==1:
        ...
        if ASD=='1':
            ...
            print('Please Try Again',end='\n\n')
            ALA=1
def generate_referance_number():
    """
     To Generate A Unique Reference Number For Every Transaction.

    Returns:
        The Unique Reference Number For The Money Trensfer.
    """
    m=n=5
    letters = string.ascii_uppercase  # All uppercasecase letters
    P1=''.join(random.choice(letters) for _ in range(1))
    P2=''.join(random.choice(letters) for _ in range(m-1))
    min_value = 10 ** (n - 1)  # Minimum value of n-digit number
    max_value = (10 ** n) - 1  # Maximum value of n-digit number
    P3=random.randint(min_value, max_value)
    P1=str(P1)
    P2=str(P2)
    P3=str(P3)
    return P1+P2+P3
def user_profile(U):
    ...
    Returns
    -------
    All The Data Stored In The System Regarding The Customer With Passed Account Number.
    '''
    print('',end='\n')
    ...
    print(D,end='\n\n')
    time.sleep(3)
def showing_account_balance(U):
    '''
    Returns
    -------
    The Account Balance Of The Customer Whose Account Number Is Passed.
    '''
    ...
    time.sleep(3)
def modifing_datails(U):
    '''
    This Function Makes Desired Changes In The Data Of The Customer Whose Account Number Is Passed.
    
    Returns
    -------
    Confinmination Of The Changes Made In The Already Existing Data.
    '''
    VVV=1
    while VVV==1:
        print('',end='\n')
        ...
        if C in ['Y','y']:
            ...
            time.sleep(1)
            VVV=2
def money_transfer(U):
    '''
    This Function Transfers Desired Amount Of Money From The Account Passed To Any Other Already Existing Account.

    Returns
    -------
    The Final Balance Of The Account After Deduction And The Transcation ID Of The Money Transfer.
    '''
    print('',end='\n')
    ...
    if CC in ['Y','y']:
        ...
        while AZ==2:
            ...
            if C in ['N','n']:
                ...
                Date=date.today()
                A1='MT'
                A2=generate_referance_number()
                Trnx_Id=str(str(A1)+str(A2))
                mycursor.execute("insert into money_sent values ('"+Trnx_Id+"','"+str(U)+"','"+str(R_Acc_No)+"','"+str(Ammnt)+"','"+str(Money_Left)+"','"+str(Date)+"','"+str(Curr_Time)+"');")
                mydb.commit()
                print('..................Your Transaction Is Successfully Completed...................',end='\n\n')
                time.sleep(2)
                print('..........Succesfully Transfered ₹'+str(Ammnt)+' From Your Bank Account........',end='\n\n')
                time.sleep(2)
                print('...........The Transaction Id For This Money Transfer Is '+Trnx_Id+'...........',end='\n\n')
                time.sleep(3)
        ...
        time.sleep(1)
        MMM=1
def details_of_transaction_of_a_customer(U):
    '''
    This Function Fetches The Data Regarding All The Transactions Liked With The Passed Account In A Given Time Period. 

    Returns
    -------
    All The Data Of The Required Transactions.
    '''
    ...
    time.sleep(5)
def money_withdrawl(U):
    '''
    This Function Withdraws Desired Ammount Of Money In Your Bank Account.

    Returns
    -------
    Updated Account Balance After The Money Withdrawl.
    '''
    mycursor.execute('select * from Accnt_Bal where Acc_No='+str(U)+';')
    AX=mycursor.fetchall()
    Bal={}
    ...
    while AZ==0:
        ...
        while AZ==1:
            ...
            if Money <= Bal[x]:
                ...
                print('The Amount To Be Withdrawed ₹'+str(Money)+' Is Greater Than Your Account Balance',end='\n\n')
...
def money_deposit(U):
    '''
    This Function Deposits Desired Ammount Of Money In Your Bank Account.

    Returns
    -------
    Updated Account Balance After The Money Deposit.
    '''
    mycursor.execute('select * from Accnt_Bal where Acc_No='+str(U)+';')
    AX=mycursor.fetchall()
    Bal={}
...
def delete_account(U):
    '''
    This Function Deletes The Details Of The Account Passed As The Argument.
    
    Returns
    -------
    Confirmination That Your Account Is Sucessfully Deleted.
    '''
    print('',end='\n')
    ...
    if C in ['y','Y']:
        ...
        mydb.commit()
        print('............Your Account With Account Number'+str(U)+' Is Succesfully Deleted.............',end='\n\n')
        time.sleep(5)
        MMM=0
        KKK=0
    elif C in ['N','n']:
...
def admin_login(KKK):
    '''
    This Prompt Defines How All The Functions Will Work In The Administrator Login.

    Returns
    -------
    The Admin Login Interface And All The Functions Related To It.
    '''
    while KKK==1:
    ...
    while AA == 3:
        ...
        if M == 1:
            ...
            graph_of_accnt_balance()
        elif M==5:
            change_default_backup_location()
        elif M==6:
            backup_all_files()
        else:
            AA=10
def user_login():
    '''
    This Prompt Defines How All The Functions Will Work In The User Login Interface.

    Returns
    -------
    The User Login Interface And All The Functions Related To It.
    '''
    KKK=1
    while KKK==1:
        mycursor.execute('select * from Accnt_pin')
        ...
        while MMM==1:
            ...
            if I==1:
                ...
                showing_account_balance(U)
            elif I==3:
                modifing_datails(U)
            elif I==4:
                money_transfer(U)
            elif I==5:
                details_of_transaction_of_a_customer(U)
            elif I==6:
                money_withdrawl(U)
            elif I==7:
                money_deposit(U)
...
def Exit():
    '''
    This Function Closes The Application After Saving All The Data Back In The Default Backup Folder.
    ...
    time.sleep(4)
# ================================================================================================================================== #
#  ##########################-|--|--|- COMPILING ALL THE FUNCTIONS TOGETHER IN A SIMGLE FUNCTION -|--|--|-#########################  #
# ================================================================================================================================== #
def Banking_Management_System():
    '''
    Hello! I'm Akshat Rauthan.
    This Is A Simple Python Application For A Banking Management System with All The Sub-Functions And Methods Embedded In It.
    This Module Uses MySQL Database In The Back-End For Storing Data And Uses Python In The Front-End To Retrieve 
    And Use The Data. This Module Also Freatures To Store All The Data In CSV Format For Its Easy Retrieval.
    This Module Is Last Updated On 10th May 2023.
    
    Returns
    -------
    The Banking Management System As A Whole.
    '''
